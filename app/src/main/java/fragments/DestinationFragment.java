...
import com.example.olivine.cholodesh.DestinationActivity;
...
public class DestinationFragment extends Fragment {
    ...
    private void changeLangView()
    {
        ...
        {
            destinatinoForChangeLang.setText("Destination");
...

    {
        ...
        {
            Toast.makeText(getActivity(),"No Location Loaded",Toast.LENGTH_LONG).show();
            return;
        }
...

        {
            ...
            public void onResponse(Call<DestinationName[]> call, Response<DestinationName[]> response) {
                ...
                if (response.body().length>0)
                {
                    ...
                    ArrayAdapter<String> testAdapter = new ArrayAdapter<String>(getActivity().getApplicationContext(),R.layout.layout_spinner,R.id.spinnerText,listchk);
