...
public class DestinationActivity extends AppCompatActivity {
    ...
    TextView divisionForLang, districtForLang,destinationName,bdforlangchnge,aboutforlang,placement;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Emergency emergency= Emergency.newInstance(2);
        Attraction attraction= Attraction.newInstance(3);
        FoodFragment foodFragment = FoodFragment.newInstance(4);
